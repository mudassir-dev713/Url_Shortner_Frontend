...
function SignupPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up | LinkSnip</title>
        <meta
          name="description"
          content="Create your free LinkSnip account and start shortening URLs with analytics."
        />
        <meta property="og:title" content="Join LinkSnip Today" />
        <meta
          property="og:description"
          content="Simple and fast signup to manage all your links."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://link-snip.netlify.app/signup"
        />
      </Helmet>
