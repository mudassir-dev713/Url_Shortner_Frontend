...
function ShortenerPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Shorten Your URL | LinkSnip</title>
        <meta
          name="description"
          content="Quickly shorten your long URLs and make them shareable and trackable with LinkSnip."
        />
        <meta property="og:title" content="Shorten Your URL | LinkSnip" />
        <meta
          property="og:description"
          content="Create short, powerful links with analytics. No signup required."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://link-snip.netlify.app/shorten"
        />
      </Helmet>

      <div className="min-h-[calc(100vh-64px)] py-12 md:px-4 px-2">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            >
              Transform long, unwieldy links into short, memorable ones with
              just one click.
            </p>
          </div>

          <div
            className={`rounded-xl shadow-lg py-6 px-2   md:p-8 transition-colors duration-200 ${
          ...
          >
            ...
            {shortenedUrl && (
              <div
                className={`mt-8 md:p-6 px-2 py-6  rounded-lg border animate-fadeIn ${
                  theme === 'dark'
          ...
          <div className="mt-2 md:text-lg text-sm">
            <strong>Note: </strong>
            Your Short Url will be deleted after 7 days if your are not logged
            in.
          </div>
        </div>
      </div>
